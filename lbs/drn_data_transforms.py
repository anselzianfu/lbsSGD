"""
Data transforms for DRN - transforms both image and label.
...
class RandomScale(object):
    """Scales the given PIL.Image to be a random size in given range.
    """
...
class RandomRotate(object):
    ...
    def __call__(self, image, *args, label=None):
        assert label is None or image.size == label.size
...
def pad_reflection(image, top, bottom, left, right):
    """ padding method - helper for different padding transforms"""
